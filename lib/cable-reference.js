...
// Shapefile (data.go.kr dataset 15130167) — gitignored, regenerate locally
// by running that script against a downloaded copy. Optional: the app runs
// fine without it (falls back to the named CABLES array only), just with
// lower nearest-cable-distance resolution. See
